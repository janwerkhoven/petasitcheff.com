...
"use strict";function mailChimp(i){var e=$.Deferred(),n="//petasitcheff.us15.list-manage.com/subscribe/post-json?u=81562367b11da2f0e94d42dbd&id=f610797f40&c=?";return isProduction&&(n="//petasitcheff.us15.list-manage.com/subscribe/post-json?u=81562367b11da2f0e94d42dbd&id=1f0a8aa42c&c=?"),$.ajax({type:"GET",url:n,data:$.param(i),cache:!1,dataType:"json",contentType:"application/json; charset=utf-8"}).done(function(i){e.resolve("success"),console.log("AJAX success",i)}).fail(function(i,n,o){e.reject("fail"),console.error("AJAX fail",i,n,o)}),e.promise()}/*! Scripts for www.reddust.org.au */
var isProduction="www.petasitcheff.com"===location.host,environment=isProduction?"production":"staging";ga&&(ga("create","UA-34474019-10","auto"),ga("set",{dimension1:environment}),ga("send","pageview")),$(document).ready(function(){$("body").addClass(environment),$("#mailchimp button").on("click",function(){var i=$(this);i.html("Subcribing...").prop("disabled",!0);var e={EMAIL:$('#mailchimp [name="email"]').val()};console.log("Submitting subscription to Mailchimp ...",e),$.when(mailChimp(e)).then(function(){i.html("Done! Check email")},function(){i.html("Whoops")})})});