...
"use strict";function mailChimp(a){var i=$.Deferred(),e="//petasitcheff.us15.list-manage.com/subscribe/post-json?u=81562367b11da2f0e94d42dbd&id=1f0a8aa42&c=?";return isProduction&&(e="//petasitcheff.us15.list-manage.com/subscribe/post-json?u=81562367b11da2f0e94d42dbd&id=1f0a8aa42&c=?"),$.ajax({type:"GET",url:e,data:$.param(a),cache:!1,dataType:"json",contentType:"application/json; charset=utf-8"}).done(function(a){i.resolve("success"),console.log("AJAX success",a)}).fail(function(a,e,o){i.reject("fail"),console.error("AJAX fail",a,e,o)}),i.promise()}/*! Scripts for www.reddust.org.au */
var isProduction="www.reddust.org.au"===location.host,environment=isProduction?"production":"staging";ga&&(ga("create","UA-34474019-10","auto"),ga("set",{dimension1:environment}),ga("send","pageview")),$(document).ready(function(){$("#mailchimp button").addClass("aaaaaah").on("click",function(){var a=$(this);a.html("Subcribing...").prop("disabled",!0);var i={EMAIL:$('#mailchimp [name="email"]').val()};console.log("Submitting subscription to Mailchimp ...",i),$.when(mailChimp(i)).then(function(){a.html("Done! Check email")},function(){a.html("Whoops")})})});