...
var email = 'peta@petasitcheff.com';
...
function submitContactForm() {
  var label = isProduction ? '' : '[TEST] ';
  var extra = isProduction ? '' : 'This is test data. It\'s very likely Jan or Hannah working on your website this very moment :)';
  var data = {
  ...
  var keys = ['name', 'email', 'phone', 'location', 'company', 'industry', 'message', 'brochure'];
  $.each(keys, function (i, key) {
    data[key] = userData[key] || '-';
  });
  console.log('Submitting contact form to FormSpree ...', data);
  var $btn = $('#contact #form button.submit');
...
$(document).ready(function () {
  ...
  var burgerPos_y = $('#menu-burger').offset().top;
  $(document).on('scroll', function () {
    var scrollPos_y = $(window).scrollTop();
  ...
  var padding8vw = $(document).width() * 8 / 100;
  var shortStoryHeight = $('#story #short>div').height() + padding8vw * 2;
  var longStoryHeight = $('#story #long>div').height() + padding8vw * 2;
  ...
  $('button.toggle').on('click', function (e) {
    ...
    var currentValue = userData[key] || false;
